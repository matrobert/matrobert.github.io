...
import dnaBackground from "@assets/DNA_bird.svg";
  ...
  return (
    <div className="h-screen relative overflow-hidden" style={{ backgroundColor: '#f8f8f8' }}>
      ...
      <div className="relative z-10 h-full overflow-y-auto">
        <div className="max-w-4xl mx-auto lg:ml-auto lg:mr-20 px-6 lg:px-12 xl:px-16 py-10 md:py-12 lg:py-16 xl:py-20">
          {/* Header */}
